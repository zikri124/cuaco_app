...
export default function AddCondtionCard({ pressure, humidity, vision, cloud, colW }: Props) {
    return (
        <div className={'card col-span-full bg-sky-600 justify-between lg:col-span-' + colW} >
            ...
            <div className='mt-6 text-center grid grid-cols-2 gap-2'>
                <div className='rounded-2xl bg-yellow-200 px-2 py-2 col-span-1 flex flex-col items-center'>
