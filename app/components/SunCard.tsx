...
export default function SunCard({ uvi, sunriseT, sunsetT }: props) {
    ...
    return (
        <div className={'card bg-amber-300 flex flex-col justify-between col-span-8 xl:col-span-4'} >
            ...
            <div className='flex flex-col items-center mt-4 bg-white px-4 py-4 rounded-2xl'>
                <div className="grid grid-cols-2 items-center w-full text-center">
                    <h4 className="col-span-1 text-2xl font-semibold">UV Index</h4>
                    <div className='col-span-1 flex items-center gap-2 justify-center'>
                        <h2 className='text-5xl font-semibold'>{uvi} </h2>
                        <div className={'text-sm font-semibold px-4 py-1 rounded-full bg-' + color}>{category}</div>
                    </div>
                </div>
                <p className='bg-white rounded-full font-semibold mt-4 text-sm'>{message}</p>
            </div>

            <div className='mt-2 text-center flex justify-between items-center text-sm px-2'>
                <div className='rounded-2xl py-2 pe-6 flex flex-col items-center'>
                ...
                <div className='rounded-2xl py-2 ps-6 flex flex-col items-center'>
